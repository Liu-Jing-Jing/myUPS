...
@interface QFYearPickerView () <UIPickerViewDataSource,UIPickerViewDelegate>{
    UIView *contentView;
...
@implementation QFYearPickerView
...
- (void)setViewInterface {
    ...
    contentView = [[UIView alloc] initWithFrame:CGRectMake(0, -300, self.frame.size.width, 300)];
...
//    //label
    ...
    for(int i=2010;i<2020;i++)
    {
        ...
        [yearLabel setFont:[UIFont systemFontOfSize:27]];
        [yearLabel setTextColor:[UIColor blackColor]];
        yearLabel.textAlignment = NSTextAlignmentCenter;
    ...
    NSArray *yearV = @[@"2019", @"2018", @"2017", @"2016", @"2015", @"2014", @"2013", @"2012", @"2011", @"2010", @"2009", @"2008"];
    for (int i=0; i<12; i++)
    {
...
- (void)selectMonhth:(UIButton *)sender
{
    ...
    NSString *yyyy = [NSString stringWithFormat:@"%d",(int)sender.tag];
    if(backBlock) backBlock(yyyy);
