...
- (void)initializeViews
{
    ...
    self.titleMaskLayer.backgroundColor = [UIColor whiteColor].CGColor;
    ...
    #warning 设置这个里的颜色改选择的文字t颜色
    self.maskTitleMaskLayer.backgroundColor = [UIColor whiteColor].CGColor;
